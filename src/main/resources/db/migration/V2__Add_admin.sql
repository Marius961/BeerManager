INSERT INTO user
    ...
    values
    (1, '1', 'admin@gmail.com', '$2a$11$SxLjGe1kDnjRapbFYuJzhu9uR89vU4CR4Tdk9VekH2J8EQSM7bDJm', 'admin', 'Admin');
...
INSERT INTO stats
    ...
    (5, 'CONFIRMED', 'Підтверджено', 'Ваше замовлення підтверджено, продавець на даний момент обробляє замовлення, скоро воно буде відправлено'),
