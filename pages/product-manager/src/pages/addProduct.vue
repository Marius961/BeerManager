            ...
            <div class="col-12">
                <div class="row">
                    <label class="col-12 col-md-6 col-lg-4 photo-input">
                        <img v-if="isPhotoSelected" :src="imageSrc" alt="">
                        <i v-if="!isPhotoSelected" class="fas fa-image"></i>
                        <input type="file" @change="onChange($event)">
                        <span v-if="!isPhotoSelected">Виберіть фото</span>
                    </label>
                    <div class="col-12 p-4 col-md-6 col-lg-8">
                        <div class="row">
                            <div class="col-12 f-form-group">
                                <label for="nameInput">Назва товару</label>
                                <input type="text" v-model="name" id="nameInput">
                            </div>
                            <div class="col-6 f-form-group">
                                <div class="row">
                            ...
                            <div class="col-6 f-form-group">
                                <div class="row">
                                    <label class="col-12" for="measurementUnit">Одиниці</label>
                                    <div class="col-12">
                                        <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-6 f-form-group p-4">
                                <div class="row">
                            ...
                            <div class="col-6 f-form-group p-4" v-if="isCategorySelected">
                                <div class="row">
